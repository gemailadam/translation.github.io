...
<section class="qwe-slideshow" >
	...
	<div class="gallerycontainer">
 	...
 	<div class="galleryPreviewContainer">
		...
		<p>
			<a href="<?php the_permalink();?>">ليجند للترجمه</a>
			<a href="<?php echo get_theme_mod( 'qwe-description1-link', '#' ); ?>">كل اللغات</a>	
			<a href="<?php  the_permalink();?>">وظائف متوفره للمترجمين</a>
		...
		<!-- Title END -->
 		...
 		<div class="gallerydescription">
 			...
 			echo get_theme_mod($description_qwe,'لتلهم احد يجب ان تلهم نفسك اولا');
 			...
 			$button_description_qwe=array('الدعم','فري لانس','ترجمه');
